...
<aside class="col-md-2" style="background-color: rgb(50, 50, 50);">
    <div>
        <div class="row">
            <div class="col-12" style="width: 100%;color: rgb(170, 170, 170);margin-top: 10px;
    ...
    <div>
        ...
        <div class="row">
            <a class="col-12 btn" style="width: 100%;color: black;
                    padding: 0px 5px 5px 30px;text-align: left;font-size: medium;
                    background-color:  #9DA1A7;" href="/staff/category/index">Danh mục</a>
        </div>
        <div class="row">
            <a class="col-12 btn" style="width: 100%;color: white;
                    padding: 0px 5px 5px 30px;text-align: left;font-size: medium;
